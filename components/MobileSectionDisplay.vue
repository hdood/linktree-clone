<template>
	<div
		...
		class="md:block relative lg:block hidden lg:w-[500px] w-[310px] h-[calc(100%-20px)]"
	>
		<div
			class="mx-auto fixed mt-16 ml-32 mb-16 flex items-center justify-center w-full lg:max-w-[230px] max-w-[200px] lg:h-[460px] h-[400px] p-3 rounded-3xl"
		>
			<img
